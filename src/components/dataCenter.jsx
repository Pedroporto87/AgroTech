...
export const DataCenter = () => {
  return (
    <>
    <Title title={"Produtos e Serviços"} description={"Datacenter"} id={"datacenter"}/>
    <section className='datacenter'>
        ...
        agrícolas.</p>
        <section>
            <img src={Edge} alt="tecnologia de ponta" className='datacenter-img'/>
        </section>
        ...
        <p>A partir de uma sólida parceria com Trusted Data o Agrotech Global é capaz de fornecer soluções de Edge Datacenters totalmente customizados para atender toda a cadeia produtiva do
        agronegócio.
        </p>
        <p>Nossas soluções de Edge Computing são robustas e utilizam o que há de mais avançado e inovador no mercado de datacenter de borda. São soluções capazes de atender, com total
        segurança, com menor consumo energético e baixo custo operacional.
        </p>
        <section>
            <img src={Edge} alt="tecnologia de ponta" className='datacenter-img'/>
        </section>
        <p>Nossas soluções podem ser oferecidas nas modalidades de:</p>
        <p className='datacenter-p'><strong>CAPEX</strong></p>
        <p><i>(do inglês, Capital Expenditure, que significa “despesas de capitais”. Sendo assim, entra no Capex a parcela dos recursos da empresa que será destinada a bens de capital.)</i></p>
        <p className='datacenter-p'><strong>OPEX</strong></p>
        <p><i>(do inglês Operational Expenditure, que significa em português “despesas operacionais”. Em outras palavras, entra no Opex todo o montante que a empresa investe em bens operacionais.)</i></p>
    </section>
    </>
